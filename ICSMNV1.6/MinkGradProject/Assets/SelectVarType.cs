...
public class SelectVarType : MonoBehaviour {
	...
	public void SaveVar(int index){
		...
		case 2:
			{
				PlayerPrefs.SetInt ("secondVar", index + 1);
				break;
			}
		case 3:
			{
				PlayerPrefs.SetInt ("thirdVar", index + 1);
				break;
			}
		case 4:
			{
				PlayerPrefs.SetInt ("fourthVar", index + 1);
				break;
			}
		}
